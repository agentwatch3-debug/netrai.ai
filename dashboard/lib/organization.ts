...
function getMockResponse(path: string): any {
  ...
  if (path.startsWith("/v1/analytics/cost-breakdown")) {
    return {
      ...
      summary: {
        total_cost: 230.6,
        total_original_llm_cost: 132.7,
        total_eval_judge_cost: 48.0,
        total_consistency_check_cost: 21.1,
        total_misunderstanding_cost: 28.8,
        total_misunderstanding_pct: 12.5,
        total_wasted_spend: 28.8,
        total_eval_overhead_cost: 69.1,
        avg_eval_overhead_pct: 30.0,
        total_sessions: 3030,
        total_successful_outcomes: 2700,
        org_success_rate_pct: 89.1,
        org_cost_per_successful_outcome: 0.085,
        tuning_candidates_count: 2,
      },
      agents: [
        {
          ...
          original_llm_cost: 14.2,
          eval_judge_cost: 8.5,
          consistency_check_cost: 9.4,
          misunderstanding_cost: 6.8,
          misunderstanding_pct: 17.5,
          total_cost: 38.9,
          eval_overhead_cost: 17.9,
          eval_overhead_pct: 46.0,
          is_tuning_candidate: true,
          tuning_recommendation: "Eval & consistency overhead is 46.0% (exceeds 40% threshold). Consistency checks account for $9.40. Consider reserving consistency mode only for critical escalation turns.",
          total_sessions: 320,
          successful_outcomes: 298,
          success_rate_pct: 93.1,
          cost_per_successful_outcome: 0.131,
        },
        {
          agent_id: "customer_support_bot",
          agent_name: "Customer Support Bot",
          role: "Customer Inquiries",
          original_llm_cost: 42.8,
          eval_judge_cost: 6.2,
          consistency_check_cost: 0.0,
          misunderstanding_cost: 11.4,
          misunderstanding_pct: 18.9,
          total_cost: 60.4,
          eval_overhead_cost: 6.2,
          eval_overhead_pct: 10.3,
          is_tuning_candidate: false,
          tuning_recommendation: null,
          total_sessions: 1450,
          successful_outcomes: 1290,
          success_rate_pct: 89.0,
          cost_per_successful_outcome: 0.047,
        },
        {
          agent_id: "market_researcher",
          agent_name: "Market Researcher",
          role: "Knowledge Discovery",
          original_llm_cost: 28.5,
          eval_judge_cost: 18.2,
          consistency_check_cost: 4.1,
          misunderstanding_cost: 3.2,
          misunderstanding_pct: 5.9,
          total_cost: 54.0,
          eval_overhead_cost: 22.3,
          eval_overhead_pct: 41.3,
          is_tuning_candidate: true,
          tuning_recommendation: "Eval & judge overhead is 41.3% (exceeds 40% threshold). Judge calls account for $18.20. Consider reducing eval sampling rate from 100% to 20% on low-risk paths.",
          total_sessions: 210,
          successful_outcomes: 182,
          success_rate_pct: 86.7,
          cost_per_successful_outcome: 0.297,
        },
        {
          agent_id: "code_reviewer",
          agent_name: "Code Reviewer Agent",
          role: "Static Analysis & PRs",
          original_llm_cost: 19.4,
          eval_judge_cost: 3.1,
          consistency_check_cost: 0.0,
          misunderstanding_cost: 1.5,
          misunderstanding_pct: 6.3,
          total_cost: 24.0,
          eval_overhead_cost: 3.1,
          eval_overhead_pct: 12.9,
          is_tuning_candidate: false,
          tuning_recommendation: null,
          total_sessions: 480,
          successful_outcomes: 445,
          success_rate_pct: 92.7,
          cost_per_successful_outcome: 0.054,
        },
        {
          agent_id: "diagnosis_assistant",
          agent_name: "Medical Triage Assistant",
          role: "Clinical Symptom Check",
          original_llm_cost: 11.3,
          eval_judge_cost: 9.8,
          consistency_check_cost: 7.6,
          misunderstanding_cost: 2.1,
          misunderstanding_pct: 6.8,
          total_cost: 30.8,
          eval_overhead_cost: 17.4,
          eval_overhead_pct: 56.5,
          is_tuning_candidate: true,
          tuning_recommendation: "Eval & judge overhead is 56.5% (exceeds 40% threshold).",
          total_sessions: 180,
          successful_outcomes: 165,
          success_rate_pct: 91.7,
          cost_per_successful_outcome: 0.187,
        },
        {
          agent_id: "sql_analyst",
          agent_name: "SQL Data Analyst",
          role: "Query Generator",
          original_llm_cost: 16.5,
          eval_judge_cost: 2.2,
          consistency_check_cost: 0.0,
          misunderstanding_cost: 4.8,
          misunderstanding_pct: 20.4,
          total_cost: 23.5,
          eval_overhead_cost: 2.2,
          eval_overhead_pct: 9.4,
          is_tuning_candidate: false,
          tuning_recommendation: null,
          total_sessions: 390,
          successful_outcomes: 320,
          success_rate_pct: 82.1,
          cost_per_successful_outcome: 0.073,
        },
      ],
      tuning_candidates: [],
      monthly_retry_loop_trends: [
        {
          ...
          top_agent_wasted_cost: 112.5,
          savings_with_clarification: 152.8,
        },
        {
          month: "May 2026",
          month_key: "2026-05",
          ...
          top_agent_wasted_cost: 98.4,
          savings_with_clarification: 135.9,
        },
        {
          month: "Jun 2026",
          month_key: "2026-06",
          ...
          top_agent: "customer_support_bot",
          top_agent_wasted_cost: 78.2,
          savings_with_clarification: 116.0,
        },
        {
          month: "Jul 2026",
          month_key: "2026-07",
          ...
          top_agent_wasted_cost: 54.1,
          savings_with_clarification: 90.0,
        },
        {
          month: "Aug 2026",
          month_key: "2026-08",
          ...
          top_agent: "refund_approval_agent",
          top_agent_wasted_cost: 41.5,
          savings_with_clarification: 62.5,
        },
        {
          month: "Sep 2026 (MTD)",
          month_key: "2026-09",
          ...
          top_agent: "customer_support_bot",
          top_agent_wasted_cost: 14.8,
          savings_with_clarification: 21.0,
        },
      ],
      retry_loops_summary: {
        current_window_wasted_cost: 28.8,
        current_window_wasted_pct: 12.5,
        historical_wasted_cost: 826.0,
        total_flagged_loops: 311,
        estimated_savings_with_clarification: 578.2,
